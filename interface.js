...
//d3.select("#main").append("div").attr("class","row").attr("id","row")//.attr("width",window.innerWidth-20)//.html("MAP")
d3.select("#main").append("div").attr("class","col").attr("id","chart")//.attr("width",window.innerWidth-20)//.html("MAP")

d3.select("#main").append("div").attr("class","col").attr("id","map")//.attr("width",window.innerWidth-20)//.html("MAP")
